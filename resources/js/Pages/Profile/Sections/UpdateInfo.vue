    ...
    <Container class="mb-6">
        ...
        <form class="space-y-6" @submit.prevent="form.patch(route('profile.info'))">
            ...
            <div v-if="user.email_verified_at == null">
                ...
                <p>Your email address is unverified. <button @click="resendEmail"
                        class="font-medium text-indigo-500 underline dark:text-indigo-400 dark:hover:text-indigo-500 disabled:text-slate-400 disabled:cursor-wait">Click
                        here to re-send the verification email.</button></p>
